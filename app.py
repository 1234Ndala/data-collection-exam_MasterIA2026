...
.kpi-icon {
    ...
    font-size: 36px; opacity: 0.18; color:#fff;
}
...
.scrape-panel {
    ...
    padding: 28px; border: 1px solid #dde4ee; max-width: 520px;
}
...
.form-card-title {
    font-size: 15px; font-weight: 800; color: #1a2a4a;
...
with tab_accueil:
    ...
    <div class="kpi-grid">
        ...
        <div class="kpi-card {"ok" if books_ok else "ko"}">
            ...
            <i class="fa-solid {"fa-circle-check" if books_ok else "fa-circle-xmark"} kpi-icon"></i>
        </div>
        <div class="kpi-card {"ok" if gaaraas_ok else "ko"}">
            ...
            <i class="fa-solid {"fa-circle-check" if gaaraas_ok else "fa-circle-xmark"} kpi-icon"></i>
        </div>
    </div>
    """, unsafe_allow_html=True)

    st.markdown("""
    <div class="section-head"><i class="fa-solid fa-table-list"></i> Sources de données</div>
    <div class="chart-panel">
        <div class="info-row">
            <span class="info-k"><i class="fa-solid fa-book-open"></i> Books to Scrape</span>
            <span class="info-v">50 pages · 9 variables · Selenium</span>
        </div>
        <div class="info-row">
            <span class="info-k"><i class="fa-solid fa-car-side"></i> Gaaraas Dakar Auto</span>
            <span class="info-v">100 pages · 7 variables · Selenium</span>
        </div>
        <div class="info-row">
        ...
        <div class="info-row">
            ...
            <span class="info-v">SQLite · 2 tables</span>
        </div>
    </div>
    </div>
    """, unsafe_allow_html=True)
...
with tab_scraping:
    st.markdown("<div class=\"page-body\">", unsafe_allow_html=True)
    st.markdown("""<div class="section-head"><i class="fa-solid fa-bolt"></i> Lancer une collecte</div>
    <div class="scrape-panel">""", unsafe_allow_html=True)
...
with tab_csv:
    st.markdown("<div class=\"page-body\">", unsafe_allow_html=True)
    st.markdown("""<div class="section-head"><i class="fa-solid fa-file-csv"></i> Données brutes — Web Scraper Chrome</div>""", unsafe_allow_html=True)
    col1, col2 = st.columns(2, gap="large")
    with col1:
        st.markdown("""<div class="chart-panel"><div class="chart-panel-title"><i class="fa-solid fa-book-open"></i> Books to Scrape</div>""", unsafe_allow_html=True)
    ...
    with col2:
        st.markdown("""<div class="chart-panel"><div class="chart-panel-title"><i class="fa-solid fa-car-side"></i> Gaaraas Dakar Auto</div>""", unsafe_allow_html=True)
...
with tab_dashboard:
    ...
    st.markdown("<div class=\"page-body\">", unsafe_allow_html=True)
    st.markdown("""<div class="section-head"><i class="fa-solid fa-chart-bar"></i> Données nettoyées · SQLite</div>""", unsafe_allow_html=True)
    ...
    with tab1:
        ...
        if df_b.empty:
            ...
            <div class="kpi-grid">
                ...
                <div class="kpi-card light"><div class="kpi-card-val">{df_b["categorie"].nunique()}</div><div class="kpi-card-label">Catégories</div><i class="fa-solid fa-tags kpi-icon"></i></div>
            </div>
            """, unsafe_allow_html=True)

            st.markdown("<div class=\"chart-panel\"><div class=\"filter-label\">Filtrer les données</div>", unsafe_allow_html=True)
            ...
            if df_f.empty:
                ...
                with c_left:
                    st.markdown("""<div class="chart-panel"><div class="chart-panel-title"><i class="fa-solid fa-chart-bar"></i> Répartition par catégorie</div>""", unsafe_allow_html=True)
                    cc = df_f["categorie"].value_counts().head(10).reset_index()
                    cc.columns=["Catégorie","Nombre"]
                    fig1 = px.bar(cc, x="Nombre", y="Catégorie", orientation="h", color_discrete_sequence=[BLEU])
                    ...
                    st.markdown("</div>", unsafe_allow_html=True)
                with c_right:
                    st.markdown("""<div class="chart-panel"><div class="chart-panel-title"><i class="fa-solid fa-circle-half-stroke"></i> Disponibilité</div>""", unsafe_allow_html=True)
                ...
                st.markdown("""<div class="chart-panel"><div class="chart-panel-title"><i class="fa-solid fa-table"></i> Aperçu des données</div>""", unsafe_allow_html=True)
        ...
        if df_v.empty:
            ...
            if df_vf.empty:
                ...
                with v_left:
                    ...
                    st.markdown("</div>", unsafe_allow_html=True)
                with v_right:
                    st.markdown("""<div class="chart-panel"><div class="chart-panel-title"><i class="fa-solid fa-gears"></i> Boîte de vitesses</div>""", unsafe_allow_html=True)
                ...
                with v2_left:
                    st.markdown("""<div class="chart-panel"><div class="chart-panel-title"><i class="fa-solid fa-location-dot"></i> Top 8 régions</div>""", unsafe_allow_html=True)
                    rg = df_vf["region"].value_counts().head(8).reset_index(); rg.columns=["Région","Nombre"]
                    ...
                    st.markdown("</div>", unsafe_allow_html=True)
                with v2_right:
                    st.markdown("""<div class="chart-panel"><div class="chart-panel-title"><i class="fa-solid fa-calendar"></i> Distribution par année</div>""", unsafe_allow_html=True)
...
with tab_forms:
    st.markdown("<div class=\"page-body\">", unsafe_allow_html=True)
    st.markdown("""<div class="section-head"><i class="fa-solid fa-clipboard-list"></i> Formulaires d'évaluation</div>""", unsafe_allow_html=True)
    col1, col2 = st.columns(2, gap="large")
    with col1:
        st.markdown("""
        <div class="form-card">
            <div class="form-card-title"><i class="fa-solid fa-square-poll-vertical"></i> KoboToolbox</div>
            <div class="form-card-desc">Partagez votre expérience sur l'application via ce formulaire hébergé sur KoboToolbox.</div>
    ...
    with col2:
        ...
        <div class="form-card">
            ...
            <div class="form-card-desc">Alternative via Google Forms pour soumettre votre évaluation de l'application.</div>
        </div>""", unsafe_allow_html=True)
